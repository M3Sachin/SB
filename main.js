...
document.querySelector("#password button").onclick = ()=>{
    const enteredPassword = document.querySelector("#password .password").value;  //password here
    if (enteredPassword === "kitten" || enteredPassword === "Kitten" || enteredPassword === "KITTEN") {
        alert("Sachin has just sent you a message.");
        ...
        var interval5 = setInterval(()=>{
            num5.innerHTML = Math.floor(Math.random()*10);
            if(num5.textContent == '9'){
                clearInterval(interval5);
                isTrue5 = true;
            }
        },300);
        var interval6 = setInterval(()=>{
            num6.innerHTML = Math.floor(Math.random()*10);
            if(num6.textContent == '9'){
